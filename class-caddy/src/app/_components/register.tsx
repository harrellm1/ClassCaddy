...
export default function Register({ goToNextPage }: { goToNextPage: (page: string) => void }) {
  ...
  const createStudent = api.user.addStudent.useMutation();
    ...
    <div style={{
      ...
      <form
        onSubmit={async (e) => {
          e.preventDefault();
          try {
            await createStudent.mutateAsync({ firstname: firstName, lastname: lastName, email: email, password: password });
